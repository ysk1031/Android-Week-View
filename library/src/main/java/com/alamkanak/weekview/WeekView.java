                ...
                case RIGHT:
                    if (!mIsScrollHorizontalDisable) {
                        mScroller.fling(
                                ...
                                0,
                                (int) getXMinLimit(),  // Integer.MIN_VALUE,
                                (int) getXMaxLimit(),  // Integer.MAX_VALUE,
                                (int) -(mHourHeight * 24 + mHeaderHeight + mHeaderRowPadding * 2 + mHeaderMarginBottom + mTimeTextHeight / 2 - getHeight()),
                                0);
                    }
                    break;
                case VERTICAL:
